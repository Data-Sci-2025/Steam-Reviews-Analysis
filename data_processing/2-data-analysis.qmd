...
It looks like maybe the "people have more to say about games they don't like" theory might be onto something. None of the longest review length averages touch the four positive game ranks. 
...
An interesting visual! The lower length reviews appear in *very* similar proportions in both categories.
...
```{r}
#| label: write_reviews_df
write_csv(reviews_df, file="../private/reviews_emojis.csv")
```
