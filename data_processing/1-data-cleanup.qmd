...
Because of the way unnest_tokens works, it spits out a DF with 9+ million rows, one token per row. My steps are:
...
tokens_df <- reviews_df |>
  unnest_tokens(tokens, review, drop=FALSE)
