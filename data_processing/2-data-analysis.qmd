...
3. What about measuring correlation between a numerical value and categorical? word count and review type. 
...
6. Also I mentioned wanting to look at review flow and date. I want to see when reviews come in, when they taper off, if there and any spikes over time...
...
8. The classifier question

9. Why is tf-idf ALL 0. I think it's not working at all bc if it was it would be 0.00000 at least but it's just 0 for every single one.
